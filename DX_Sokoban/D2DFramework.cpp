...
HRESULT D2DFramework::InitWindow(HINSTANCE hInstance, LPCWSTR title, UINT width, UINT height)
{
	...
	wc.lpszClassName = WINDOWS_CLASSNAME;
...
HRESULT D2DFramework::Initialize(HINSTANCE hInstance, LPCWSTR title, UINT width, UINT height)
{
	...
	hr = BitmapManager::Instance().Inintialize(mspRenderTarget.Get());
...
LRESULT CALLBACK D2DFramework::WinProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	D2DFramework* pFramewokr = reinterpret_cast<D2DFramework*> 
